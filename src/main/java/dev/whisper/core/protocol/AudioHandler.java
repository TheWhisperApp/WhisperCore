...
package dev.whisper.core.protocol;

import android.content.Context;
import android.media.AudioManager;
import android.util.Log;

import dev.whisper.core.R;
import dev.whisper.core.audio.AudioInput;
import dev.whisper.core.audio.AudioOutput;
import dev.whisper.core.audio.encoder.CELT11Encoder;
...
import dev.whisper.core.audio.encoder.PreprocessingEncoder;
import dev.whisper.core.audio.encoder.ResamplingEncoder;
import dev.whisper.core.audio.inputmode.IInputMode;
import dev.whisper.core.exception.AudioException;
import dev.whisper.core.exception.AudioInitializationException;
...
import dev.whisper.core.util.HumlaNetworkListener;
