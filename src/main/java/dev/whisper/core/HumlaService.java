...
import dev.whisper.core.audio.AudioOutput;
import dev.whisper.core.audio.BluetoothScoReceiver;
import dev.whisper.core.audio.inputmode.ActivityInputMode;
import dev.whisper.core.audio.inputmode.ContinuousInputMode;
import dev.whisper.core.audio.inputmode.IInputMode;
import dev.whisper.core.audio.inputmode.ToggleInputMode;
import dev.whisper.core.audio.javacpp.CELT7;
import dev.whisper.core.exception.AudioException;
import dev.whisper.core.exception.NotConnectedException;
import dev.whisper.core.exception.NotSynchronizedException;
import dev.whisper.core.model.Channel;
import dev.whisper.core.model.IChannel;
import dev.whisper.core.model.IUser;
import dev.whisper.core.model.Message;
import dev.whisper.core.model.Server;
import dev.whisper.core.model.ServerSettings;
import dev.whisper.core.model.TalkState;
import dev.whisper.core.model.User;
import dev.whisper.core.model.WhisperTarget;
import dev.whisper.core.model.WhisperTargetList;
import dev.whisper.core.net.HumlaConnection;
import dev.whisper.core.net.HumlaTCPMessageType;
import dev.whisper.core.net.HumlaUDPMessageType;
import dev.whisper.core.protobuf.Mumble;
import dev.whisper.core.protocol.AudioHandler;
import dev.whisper.core.protocol.ModelHandler;
import dev.whisper.core.util.HumlaCallbacks;
import dev.whisper.core.util.HumlaDisconnectedException;
import dev.whisper.core.util.HumlaException;
import dev.whisper.core.util.HumlaLogger;
...
public class HumlaService extends Service implements IHumlaService, IHumlaSession, HumlaConnection.HumlaConnectionListener, HumlaLogger, BluetoothScoReceiver.Listener {
     ...
     */
    public static final String ACTION_CONNECT = "dev.whisper.core.CONNECT";
...
//            auth.addCeltVersions(Constants.CELT_11_VERSION);
     ...
     * @see dev.whisper.core.HumlaService
     */
